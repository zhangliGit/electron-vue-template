<template>
  <div class="update-win">
    <template v-if="!showDownload">
      <div class="title">
        发现新版本 <small v-if="remoteVersionFromApp">v{{ remoteVersionFromApp }}</small>
      </div>
      <div class="content">
...
export default {
  ...
  methods: {
    ...
    goRoute() {
      remote.shell.openExternal('https://github.com/xiaozhu188/electron-vue-cloud-music/releases')
    },
    download() {
